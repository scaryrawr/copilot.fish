...
complete -c copilot -l resume -r -d 'Resume from a previous session (optionally specify session ID)'
...
complete -c copilot -l share -r -d 'Share session to markdown file after completion'
